                            ...
                            <form action="{{ route('admin.demandes.update', $demande->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="statut" id="statut" class="form-control">
                                        <option value="non traité" {{ $demande->statut == 'non traité' ? 'selected' : '' }}>Non traité</option>
                                ...
                                <button href="{{route('admin.demandes.index')}}" class="btn btn-danger">Annuler</button>
                            </form>
                        </div>
                    </div>
                </div>
